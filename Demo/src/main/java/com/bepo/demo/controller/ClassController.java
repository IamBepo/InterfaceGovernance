...
@ApiClass(name = "班级接口群", description = "用于调用班级相关（如查询、新增等）操作的接口")
public class ClassController {

    @GetMapping("/query/class/{id}")
    @ApiMethod(name = "查询班级信息", params = {"Integer id"}, method = "GET", description = "提供{班级号}查询班级所有信息")
    ...
    @ApiMethod(name = "新增班级", params = {"String name"}, method = "POST", description = "提供{班级名}新增单个班级")
    public Result addUser(String name){
