...
@ApiClass(name = "用户接口群", description = "用于调用用户相关（如查询、新增等）操作的接口")
public class UserController {

    @GetMapping("/query/user/{username}")
    @ApiMethod(name = "查询用户信息", params = {"String username"}, method = "GET", description = "提供{用户名}查询用户所有信息")
    ...
    @ApiMethod(name = "新增用户", params = {"String username", "String password"}, method = "POST", description = "提供{用户名, 密码}新增单个用户")
